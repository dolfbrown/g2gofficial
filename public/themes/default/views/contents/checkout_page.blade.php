      ...
      <div class="row space30">
        ...
        <div class="col-md-5">
          <h3 class="widget-title">
            {{ $is_downloadable ? trans('theme.billing_address') : trans('theme.ship_to') }}
          </h3>
          @if(isset($customer))
          ...
          @else
              ...
              <div id="create-account" class="space30" style="display: none;">
                ...
                <p class="text-info small">
                  ...
                  {!! trans('theme.help.create_account_on_checkout', ['link' => get_page_url(\App\Page::PAGE_TNC)]) !!}
                </p>
              </div>
          @endif
        ...
        <div class="col-md-4">
            ...
            <div class="space30">
              @foreach($payment_methods as $payment_provider)
                @php
                  switch ($payment_provider->code) {
                    ...
                    case 'wire':
                      $info = config('system_settings.wire_additional_details');
                      break;

                    case 'cod':
                      $info = config('system_settings.cod_additional_details');
                      break;
                ...
                @continue( ! $payment_provider->isConfigured() )

			                ...
			                <tr class="order-body">
			                        ...
			                        <div class="product-info">
			                            ...
			                            <div class="order-info-amount">
											...
											@if($item->downloadable)
				                            	<a href="{{ route('order.download', ['order' => $order, 'product' => $item]) }}" class="indent10"><i class="fa fa-download"></i> @lang('theme.download')</a>
				                          	@endif
			                            </div>
			                            {{--
		                    	...
		                    	@if($loop->first)
				                    <td rowspan="{{ $loop->count }}" class="order-actions">
						                ...
						                @if($is_downloadable || $order->goods_received)
			          	...
			          	<div class="col-xs-2 nopadding-right">
			          		@unless($msg->customer_id)
				              	<div class="message-user-info">
				                  	<div class="message-user-name" title="seller">{{ get_platform_title() }}</div>

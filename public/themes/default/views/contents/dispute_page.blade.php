  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8">
              ...
              <ul>
                ...
                ">
                  <a id="step2">
                    ...
                    <span class="title">{!! trans('theme.on_progress') !!}</span>
                  </a>
                </li>
                <li class="
                  @if($progress == 100)
                ...
                ">
                  <a id="step3">
                    ...
                    <span class="title">{!! trans('theme.appealed') !!}</span>
                  </a>
                </li>
              ...
              <tbody>
                  <tr class="order-info-head">
                      <td width="50%">
                        ...
                        <h5>
                            <span>{!! trans('theme.dispute_status') !!}</span>
        ...
        @else
          <p class="text-center">
              <a href="{{ route('order.detail', $order) . '#message-section' }}" class="btn btn-primary flat">{!! trans('theme.button.contact_us') !!}</a>

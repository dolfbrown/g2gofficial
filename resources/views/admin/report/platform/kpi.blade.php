          ...
          <table class="table no-margin table-condensed table-no-sort">
              ...
              <tbody>
                @foreach($top_listings as $item)
                  <tr>
                    <td>
                        <img src="{{ get_storage_file_url(optional($item->image)->path, 'tiny') }}" class="img-md" alt="{{ trans('app.image') }}">
                    </td>
                    <td>
                        <h5 class="nopadding">
                    ...
                    <td>
                      @if($item->attributeValues)
                        {{ implode(' | ', array_column($item->attributeValues->toArray(), 'value') ) }}
                      @endif
                    </td>
                    <td class="text-center">{{ $item->sold_qtt }}</td>
                    <td class="text-center">{{ get_formated_currency($item->gross_sales) }}</td>
                    <td>&nbsp;</td>
                  </tr>
                @endforeach
              </tbody>

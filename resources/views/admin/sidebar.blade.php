...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        @if(Gate::allows('index', \App\Category::class) || Gate::allows('index', \App\Attribute::class) || Gate::allows('index', \App\Product::class) || Gate::allows('index', \App\Manufacturer::class) || Gate::allows('index', \App\Supplier::class) || Gate::allows('index', \App\CategoryGroup::class) || Gate::allows('index', \App\CategorySubGroup::class))
          <li class="treeview {{ Request::is('admin/catalog*') ? 'active' : '' }}">
            ...
            <ul class="treeview-menu">
              ...
              @can('index', \App\Product::class)
                ...
                <li class=" {{ Request::is('admin/catalog/downloadable*') ? 'active' : '' }}">
                  <a href="{{ url('admin/catalog/downloadable') }}">
                    <i class="fa fa-angle-double-right"></i> {{ trans('nav.downloadables') }}
                  </a>
                </li>
              @endcan

              @can('index', \App\Supplier::class)
                <li class=" {{ Request::is('admin/catalog/supplier*') ? 'active' : '' }}">
                  <a href="{{ url('admin/catalog/supplier') }}">
        ...
        @if(Gate::allows('index', \App\Carrier::class) || Gate::allows('index', \App\Packaging::class) || Gate::allows('index', \App\Warehouse::class) || Gate::allows('index', \App\ShippingZone::class))
          <li class="treeview {{ Request::is('admin/shipping*') ? 'active' : '' }}">
            ...
            <ul class="treeview-menu">
              @can('index', \App\Warehouse::class)
                <li class=" {{ Request::is('admin/shipping/warehouse*') ? 'active' : '' }}">
                  <a href="{{ url('admin/shipping/warehouse') }}">
        ...
        <li class="treeview {{ Request::is('admin/setting*') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            @if(Auth::user()->isAdmin())
              <li class=" {{ Request::is('admin/setting/payment_method*') ? 'active' : '' }}">
                <a href="{{ url('admin/setting/payment_method') }}">
              ...
              <li class=" {{ Request::is('admin/setting/fb_messenger') ? 'active' : '' }}">
                <a href="{{ url('admin/setting/fb_messenger') }}">
                  <i class="fa fa-angle-double-right"></i> {{ trans('nav.fb_messenger') }}
                </a>
              </li>
            @endif
          </ul>

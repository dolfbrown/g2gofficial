<div class="modal-dialog modal-sm">
    <div class="modal-content">
        {!! Form::model($shippingZone, ['method' => 'PUT', 'route' => ['admin.shipping.shippingZone.updateStates', $shippingZone->id, $country], 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']) !!}
            ...
            <table class="table table-striped" id="search_table">
                <tbody>
                    @foreach($states as $state_id => $state_name)
                        <tr>
                            <td>
                                {!! Form::checkbox('states[]', $state_id, in_array($state_id, $shippingZone->state_ids), ['id' => $state_id, 'class' => 'icheckbox_line']) !!}

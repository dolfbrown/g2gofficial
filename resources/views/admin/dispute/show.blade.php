			...
			<div class="box">
			    ...
			    <div class="box-body">
					...
					<p>
						...
						<span class="label label-outline">{{ \App\Helpers\Statistics::dispute_count() }}</span>
					</p>
					<p>
						{{ trans('app.latest_days', ['days' => 30]) }}:
						<span class="label label-info"><strong>{{ \App\Helpers\Statistics::dispute_count(30) }}</strong></span>
					</p>
	    		</div>
	    	</div>
	    </div>

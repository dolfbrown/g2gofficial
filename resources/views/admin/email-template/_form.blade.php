...
<div class="row">
  <div class="col-md-6 nopadding-right">
    <div class="form-group">
      ...
      {!! Form::email('sender_email', isset($template->sender_email) ? $template->sender_email : config('system_settings.default_sender_email_address'), ['class' => 'form-control', 'placeholder' => trans('app.placeholder.valid_email'), 'required']) !!}
      <div class="help-block with-errors"></div>
    </div>
  </div>
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      ...
      {!! Form::text('sender_name', isset($template->sender_name) ? $template->sender_name : config('system_settings.default_email_sender_name'), ['class' => 'form-control', 'placeholder' => trans('app.placeholder.template_sender_name'), 'required']) !!}
      <div class="help-block with-errors"></div>
    </div>
  </div>
</div>

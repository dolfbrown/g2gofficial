		...
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				@can('create', App\Warehouse::class)
					<a href="javascript:void(0)" data-link="{{ route('admin.shipping.warehouse.create') }}" class="ajax-modal-btn btn btn-new btn-flat">{{ trans('app.add_warehouse') }}</a>
				@endcan
			</div>
		</div> <!-- /.box-header -->
		<div class="box-body">
				...
				<tbody>
					...
					<tr>
						...
						<td class="row-options">
							@can('view', $warehouse)
								<a href="javascript:void(0)" data-link="{{ route('admin.shipping.warehouse.show', $warehouse->id) }}"  class="ajax-modal-btn"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.detail') }}" class="fa fa-expand"></i></a>&nbsp;
							@endcan

							@can('update', $warehouse)
								<a href="javascript:void(0)" data-link="{{ route('admin.shipping.warehouse.edit', $warehouse->id) }}"  class="ajax-modal-btn"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.edit') }}" class="fa fa-edit"></i></a>&nbsp;
							...
							@can('delete', $warehouse)
								{!! Form::open(['route' => ['admin.shipping.warehouse.trash', $warehouse->id], 'method' => 'delete', 'class' => 'data-form']) !!}
			...
			<table class="table table-hover table-2nd-short">
				...
				<tbody>
					...
					<tr>
						...
						<td class="row-options">
							@can('delete', $trash)
								<a href="{{ route('admin.shipping.warehouse.restore', $trash->id) }}"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.restore') }}" class="fa fa-database"></i></a>&nbsp;

								{!! Form::open(['route' => ['admin.shipping.warehouse.destroy', $trash->id], 'method' => 'delete', 'class' => 'data-form']) !!}

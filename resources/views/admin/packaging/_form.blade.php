...
<div class="row">
  <div class="col-sm-4 col-xs-12 nopadding-right">
    <div class="form-group">
        ...
        <div class="input-group">
          {!! Form::number('width', null, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('app.placeholder.width')]) !!}
  ...
  <div class="col-sm-4 col-xs-12 nopadding">
    <div class="form-group">
      ...
      <div class="input-group">
        {!! Form::number('height', null, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('app.placeholder.height')]) !!}
        <span class="input-group-addon">{{ config('system_settings.length_unit') ?: 'cm' }}</span>
      </div>
      <div class="help-block with-errors"></div>
    </div>
  ...
  <div class="col-sm-4 col-xs-12 nopadding-left">
    <div class="form-group">
      ...
      <div class="input-group">
        {!! Form::number('depth', isset($packaging) ? null : 0, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('app.placeholder.depth')]) !!}
        <span class="input-group-addon">{{ config('system_settings.length_unit') ?: 'cm' }}</span>
      </div>
      <div class="help-block with-errors"></div>
    </div>

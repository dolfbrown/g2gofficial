    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
              ...
              {!! Form::textarea('additional_details', config('system_settings.' . $paymentMethod->code . '_additional_details'), ['class' => 'form-control summernote-without-toolbar', 'placeholder' => trans('app.placeholder.additional_details'), 'required']) !!}
            ...
            <div class="form-group">
              ...
              {!! Form::textarea('payment_instructions', config('system_settings.' . $paymentMethod->code . '_payment_instructions'), ['class' => 'form-control summernote', 'placeholder' => trans('app.placeholder.payment_instructions'), 'required']) !!}
              <div class="help-block with-errors"></div>
            </div>
        </div>

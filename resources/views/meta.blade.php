...
@if (config('seo.enabled'))
    ...
    @if(isset($item))
        ...
        <meta name="product:price:currency" content="{!! get_currency_code() !!} ">
        <meta name="product:price:amount" content="{!! get_formated_currency($item->currnt_price(), config('system_settings.decimals', 2)) !!}">
        <meta name="product:brand" content="{!! $item->manufacturer->name !!}">

        @php
            $item_images = $item->images->count() ? $item->images : $item->images;
    ...
    @if(isset($item))
        ...
        <meta name="twitter:data1" content="{!! get_formated_currency($item->currnt_price(), config('system_settings.decimals', 2)) !!}">
        ...
        <meta name="twitter:data3" content="{!! get_currency_code() !!} ">
        <meta name="twitter:label4" content="brand">
        <meta name="twitter:data4" content="{!! $item->manufacturer->name !!}">
        ...
        <script type="application/ld+json">
            {
                ...
                "offers": {
                    ...
                    "price": "{!! get_formated_decimal($item->currnt_price(), true, config('system_settings.decimals', 2)) !!}"

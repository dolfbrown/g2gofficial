...
class Order extends Model
{
    ...
    public function products()
    {
        ...
        ->withPivot('id','item_description','variant_id','quantity','unit_price','feedback_id')
        ->withTimestamps();
    }
    ...
    /**
     * Scope a query to only include Archived records also.
     *
    ...
    {
        $total = 0;
        $items = $this->products->pluck('pivot');
   ...
   /**
     * Check if the order have only downloadables
     *
     * @return bool
     */

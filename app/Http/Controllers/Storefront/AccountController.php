...
class AccountController extends Controller
{
    ...
    {
        return Wishlist::mine()->whereHas('product', function($q) {
            $q->available();
        })->with([
            'product', 'product.feedbacks:rating,feedbackable_id,feedbackable_type',
            'product.images:path,imageable_id,imageable_type'
        ])->paginate(7);
    }
    ...
    private function disputes()
    {
        ...
        ->with(['order.products', 'order.products.image'])
        ->paginate(10);
    }

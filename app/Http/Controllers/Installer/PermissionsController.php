...
*/
 namespace App\Http\Controllers\Installer; use App\Http\Requests; use Illuminate\Routing\Controller; use App\Http\Controllers\Installer\Helpers\PermissionsChecker; class PermissionsController extends Controller { protected $permissions; public function __construct(PermissionsChecker $checker) { $this->permissions = $checker; } public function permissions() { $permissions = $this->permissions->check(config("\151\156\163\x74\x61\154\154\x65\162\x2e\x70\145\162\155\151\x73\x73\151\157\156\x73")); return view("\x69\x6e\x73\x74\141\x6c\154\145\162\56\160\x65\x72\x6d\x69\163\163\x69\x6f\x6e\163", compact("\x70\145\162\x6d\151\x73\163\151\x6f\156\163")); } }
